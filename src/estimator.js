...
const covid19ImpactEstimator = (data) => {
    ...
    impact.dollarsInFlight = (
        impact.infectionsByRequestedTime * data.region.avgDailyIncomePopulation * data.region.avgDailyIncomeInUSD * days).toFixed(2);
    severeImpact.dollarsInFlight = (
        severeImpact.infectionsByRequestedTime * data.region.avgDailyIncomePopulation * data.region.avgDailyIncomeInUSD * days).toFixed(2);
